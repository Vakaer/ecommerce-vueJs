<template>
  <div
    class="relative  flex  max-w-xs w-full h-h-400 flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
    <a class="relative mx-3 mt-3 flex  justify-center h-60 overflow-hidden rounded-xl" href="#">
      <div class="flex justify-center">
        <img class="object-contain h-full" :src="product.image" alt="product image" />
      </div>
    ...
    <div class="mt-4 px-5 pb-5">
      ...
      <button href="#" @click="handleAddItemsToCart(product.id)"
...
export default {
  ...
  methods: {
    handleAddItemsToCart(id) {
      this.$emit('handle-add-items-to-cart', id)
    }
  }
